...
Комплексный скрипт оптимизации VPS серверов на базе Debian/Ubuntu с XanMod kernel, Zsh + Starship, Docker и усиленной безопасностью.

**🚀 Версия 1.0.0** - Стабильная версия с полным набором оптимизаций для production VPS.
...
- **оптимизированные пулы адресов** - избежание конфликтов
